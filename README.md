...
Toolkit использует кодовую страницу Windows-1251. Если заполняете CSV вручную, сохраняйте файл в обычной ANSI/Windows-1251 кодировке. В таком виде русские имена корректно отображаются в cmd.
